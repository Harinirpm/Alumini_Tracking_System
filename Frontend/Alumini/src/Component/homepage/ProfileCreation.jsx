      ...
      const fetchProfile = async () => {
        try {
          const response = await axios.get(
            `https://alumini-tracking-system.onrender.com/alumini/profile/${id}`
          );
      ...
      if (profileCreated) {
        ...
        if (checkResponse.status === 200 && checkResponse.data) {
          ...
          const updateResponse = await axios.put(
            `https://alumini-tracking-system.onrender.com/alumini/update/profile/${id}`,
            postData,
            {
              headers: {
        ...
        const response = await axios.post(
          "https://alumini-tracking-system.onrender.com/alumini/create/profile",
          postData,
          {
            headers: {
              "Content-Type": "multipart/form-data",
                ...
                >
                    ...
                    <TableCell align="right" sx={{ border: "none" }}>
                      ...
                      {image && modify ? (
                        <div style={{ marginTop: "7px" }}>
                          <a
                            href={`https://alumini-tracking-system.onrender.com/${image.replace(
                              /\\/g,
                              "/"
                  ...
                  >
                    ...
                    <TableCell align="right" sx={{ border: "none" }}>
                      <input
                        id="outlined-basic"
                        placeholder="Current Role in workplace"
                        variant="outlined"
                        value={role}
                  ...
                  >
                    ...
                    <TableCell align="right" sx={{ border: "none" }}>
                      <input
                        id="outlined-basic"
                        placeholder="Experience in the current role"
                        variant="outlined"
